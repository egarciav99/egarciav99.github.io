...
const TRANSLATIONS = {
  en: {
    ...
    job1_li1: `Led the outdoor electrical front at <strong>Microsoft's Azure hyperscale Data Center</strong> in Querétaro (~3 football fields) — from newest hire to sole front lead in 6 months, directly supervising <strong>60+ people</strong>: medium voltage, grounding, transformers, generators and switchgear.`,
  ...
  es: {
    ...
    job1_li1: `Lideré el frente eléctrico de exteriores del <strong>Data Center Azure de hiperescala de Microsoft</strong> en Querétaro (~3 canchas de fútbol) — de ser el más nuevo del equipo a encargado único del frente en 6 meses, supervisando a <strong>más de 60 personas</strong>: media tensión, tierras, transformadores, generadores y tableros.`,
