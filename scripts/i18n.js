...
const TRANSLATIONS = {
  en: {
    ...
    about_p1: `I'm <strong>Elier Garcia</strong>, an electrical engineer from Chihuahua, Mexico. I built my foundation tackling high-stakes field challenges: supervising electrical infrastructure for <strong>Microsoft's Azure hyperscale data center</strong> and a <strong>19,847 m² industrial facility for BMW Group</strong>. Within six months, I stepped up from new hire to running the exterior electrical front solo, managing up to <strong>60 workers</strong>.`,
    ...
    job1_li1: `Led the full electrical front at <strong>Microsoft's Azure hyperscale Data Center</strong> in Querétaro (~3 football fields) — escalated from newest hire to sole front lead in 6 months, coordinating up to <strong>60 people</strong> over 9 months.`,
  ...
  es: {
    ...
    job1_li1: `Lideré el frente eléctrico completo en el <strong>Data Center Azure de hiperescala de Microsoft</strong> en Querétaro (~3 canchas de fútbol) — escalé de ser el más nuevo en el equipo a encargado único del frente en 6 meses, coordinando hasta <strong>60 personas</strong> durante 9 meses.`,
